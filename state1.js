...
var cursors, vel = 500, grass, rocks;
...
demo.state1.prototype = {
    ...
    create: function() {
        game.physics.startSystem(Phaser.Physics.ARCADE); //WE REALLY DONT HAVE TO DO THIS SINCE WE ALREADY DID IT IN state0. BUT if this was a seperate project, then we would need to do it. 
        ...
        adam = game.add.sprite(230, 200, 'adam');
